...
**     Date/Time : 2019-06-22, 20:02, # CodeGen: 1
**     Abstract  :
...
void MCU_init(void)
{
  ...
  TPM1C0SC = 0x50U;                    /* Int. flag clearing (2nd part) and channel 0 contr. register setting */
  TPM1C0V = 0x00U;                     /* Compare 0 value setting */
  (void)(TPM1C1SC == 0U);              /* Channel 1 int. flag clearing (first part) */
  /* TPM1C1SC: CH1F=0,CH1IE=1,MS1B=0,MS1A=1,ELS1B=0,ELS1A=1 */
  TPM1C1SC = 0x54U;                    /* Int. flag clearing (2nd part) and channel 1 contr. register setting */
  TPM1C1V = 0x00U;                     /* Compare 1 value setting */
